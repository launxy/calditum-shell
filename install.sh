...
# ==============================================================================
# Calditum Shell
# Fork by launxy — original shell created by ilyamiro
# https://github.com/launxy/calditum-shell
# ==============================================================================
# Script Versioning & Initialization
# ==============================================================================
DOTS_VERSION="1.0.0"
VERSION_FILE="$HOME/.local/state/calditum-shell-version"
...
ARCH_PKGS=(
    ...
    "qt5ct" "qt6ct" "gpu-screen-recorder" "adw-gtk-theme" "xdg-desktop-portal-wlr" "wvbkd" 
)
...
draw_header() {
 ...
 / ___|__ _| | __| (_) | |_ _   _ _ __ / ___|| |__   ___| | |
| |   / _` | |/ _` | | | __| | | | '_ ` \___ \| '_ \ / _ \ | |
| |__| (_| | | (_| | | | |_| |_| | | | |___) | | | |  __/ | |
 \____\__,_|_|\__,_|_|  \__|\__,_|_| |_|____/|_| |_|\___|_|_|
EOF
    printf "${RESET}\n"

    local OSC8_GH="\e]8;;https://github.com/launxy/calditum-shell.git\a"
    local OSC8_ORIG="\e]8;;https://github.com/ilyamiro\a"
    local OSC8_END="\e]8;;\a"

    printf "\033[K${C_BLUE} -----------------------------------------------------------------${RESET}\n"
    printf "\033[K${BOLD}${C_GREEN} GitHub:${RESET}  ${OSC8_GH}https://github.com/launxy/calditum-shell.git${OSC8_END}\n"
    printf "\033[K${BOLD}${C_CYAN} Fork by:${RESET} launxy  |  ${BOLD}${C_MAGENTA}Original shell by:${RESET} ${OSC8_ORIG}ilyamiro${OSC8_END}\n"
    printf "\033[K${C_BLUE} -----------------------------------------------------------------${RESET}\n"
...
show_overview() {
    ...
    echo -e "Calditum Shell is a fork by ${BOLD}${C_CYAN}launxy${RESET}, based on the original shell created by ${BOLD}${C_CYAN}ilyamiro${RESET}."
...
prompt_optional_features_menu() {
    ...
    if command -v jq &>/dev/null && command -v curl &>/dev/null; then
        local UPDATES_JSON=$(curl -s "https://raw.githubusercontent.com/launxy/calditum-shell/${TARGET_BRANCH}/updates.json" 2>/dev/null)
...
REPO_URL="https://github.com/launxy/calditum-shell.git"
...
CONFIG_FOLDERS=("cava" "hypr" "kitty" "rofi" "matugen" "zsh" "swayosd" "xdg-desktop-portal")
...
echo -e "${BOLD}${C_YELLOW} Calditum Shell${RESET}"
echo -e " Fork maintained by ${BOLD}${C_CYAN}launxy${RESET}"
echo -e " Original shell created by ${BOLD}${C_CYAN}ilyamiro${RESET} — all credit for the original design goes to them."
echo -e " ${BOLD}${C_CYAN}GitHub:${RESET} https://github.com/launxy/calditum-shell"
echo -e "${BOLD}${C_MAGENTA}=================================================================${RESET}\n"
