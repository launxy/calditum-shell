                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout { 
                            ...
                            Text { text: screenRoot.kbLayout; font.family: "Liberation Sans"; font.pixelSize: 14 * screenRoot.sc; font.weight: Font.Black; color: root.text }
                        }
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                ...
                                Text { text: "Reboot"; font.family: "Liberation Sans"; font.pixelSize: 15 * screenRoot.sc; font.weight: Font.Medium; color: ma1.containsMouse ? root.blue : Qt.rgba(root.blue.r, root.blue.g, root.blue.b, 0.6); Behavior on color { ColorAnimation { duration: 200 } } }
                            }
                            MouseArea { 
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                ...
                                Item { Layout.fillWidth: true }
                                Text { text: "Suspend"; font.family: "Liberation Sans"; font.pixelSize: 15 * screenRoot.sc; font.weight: Font.Medium; color: ma2.containsMouse ? root.mauve : Qt.rgba(root.mauve.r, root.mauve.g, root.mauve.b, 0.6); Behavior on color { ColorAnimation { duration: 200 } } }
                            }
                            MouseArea { 
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                ...
                                Item { Layout.fillWidth: true }
                                Text { text: "Power Off"; font.family: "Liberation Sans"; font.pixelSize: 15 * screenRoot.sc; font.weight: Font.Medium; color: ma3.containsMouse ? root.red : Qt.rgba(root.red.r, root.red.g, root.red.b, 0.6); Behavior on color { ColorAnimation { duration: 200 } } }
                            }
                            MouseArea { 
