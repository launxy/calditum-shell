...
function getLayout(name, mx, my, mw, mh, userScale) {
    ...
    let base = {
        ...
        // DISABLED (minimalist shell): "stewart": { w: s(800, scale), h: s(650, scale), rx: Math.floor((mw/2)-(s(800, scale)/2)), ry: Math.floor((mh/2)-(s(650, scale)/2)), comp: "stewart/stewart.qml" },
        ...
        "color":     { w: s(1000, scale), h: s(720, scale), rx: Math.floor((mw/2)-(s(1000, scale)/2)), ry: Math.floor((mh/2)-(s(720, scale)/2)), comp: "color/ColorPicker.qml" },
