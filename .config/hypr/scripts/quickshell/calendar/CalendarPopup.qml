                            ...
                            Rectangle {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { 
                                        Layout.alignment: Qt.AlignHCenter
                                        text: modelData.time
                                        font.family: "Liberation Sans"; font.weight: Font.Bold; font.pixelSize: Math.round(12 * window.sf)
                                    ...
                                    Text { 
                                        ...
                                        font.family: "Liberation Sans"; font.weight: Font.Black; font.pixelSize: Math.round(14 * window.sf)
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                anchors.centerIn: parent
                                spacing: Math.round(6 * window.sf)
                                Text { text: "Open Web"; font.family: "Liberation Sans"; font.weight: Font.Bold; font.pixelSize: Math.round(14 * window.sf); color: schLinkMa.containsMouse ? window.base : window.text }
                                        ...
                                        Item {
                                            ...
                                            ColumnLayout {
                                                ...
                                                RowLayout {
                                                    ...
                                                    Text { text: modelData.time || ""; font.family: "Liberation Sans"; font.weight: Font.Bold; font.pixelSize: Math.round(14 * window.sf); color: classNode.isActive ? window.text : window.overlay1 }
                                                }
                                                ...
                                                RowLayout {
                                                    ...
                                                    Text { text: modelData.room || ""; font.family: "Liberation Sans"; font.weight: Font.Bold; font.pixelSize: Math.round(14 * window.sf); color: window.subtext1; elide: Text.ElideRight; Layout.fillWidth: true }
                                                }
                                            }
