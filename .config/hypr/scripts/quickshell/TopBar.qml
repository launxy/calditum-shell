            ...
            Process {
                ...
                stdout: StdioCollector {
                    onStreamFinished: {
                        ...
                        kbWaiter.running = false;
                        barWindow.fastPollerLoaded = false; 
                    }
                }
            }
            ...
            Item {
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            spacing: -2
                            Text { text: barWindow.timeStr; Layout.alignment: Qt.AlignLeft; font.family: "Liberation Sans"; font.pixelSize: barWindow.s(16); font.weight: Font.Black; color: mocha.blue }
                        }
                    }
                }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Rectangle {
                                id: kbdPill
                                property bool isHovered: kbdMouse.containsMouse
                                color: isHovered ? Qt.rgba(mocha.surface1.r, mocha.surface1.g, mocha.surface1.b, 0.6) : Qt.rgba(mocha.surface0.r, mocha.surface0.g, mocha.surface0.b, 0.4)
                                radius: barWindow.s(10); height: sysLayout.pillHeight
                                clip: true

                                property real targetWidth: kbdLayoutRow.implicitWidth + barWindow.s(24)
                                width: targetWidth
                                ...
                                MouseArea {
                                    ...
                                    hoverEnabled: true
                                    anchors.fill: parent
                                    onClicked: Quickshell.execDetached(["bash", "-c", "pkill wvkbd-mobintl || wvkbd-mobintl -L 300"])
                                }
                            }
                            ...
                            Rectangle {
                                ...
                                Row { 
                                    ...
                                    Text { 
                                        anchors.verticalCenter: parent.verticalCenter
                                        text: barWindow.isDesktop ? "󰐥" : barWindow.batIcon; 
                                    ...
                                    Text { 
                                        ...
                                        text: barWindow.batPercent; font.family: "Liberation Sans"; font.pixelSize: barWindow.s(13); font.weight: Font.Black; 
                                        color: mocha.base 
                                        Behavior on color { ColorAnimation { duration: 300 } }
                                    }
                                }
