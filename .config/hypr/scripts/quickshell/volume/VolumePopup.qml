                        ...
                        ColumnLayout {
                            ...
                            ColumnLayout {
                                ...
                                Text {
                                    ...
                                    font.family: "Liberation Sans"; font.weight: Font.Black; font.pixelSize: window.s(20)
                                    color: window.text
                    ...
                    ListView {
                        ...
                        Item {
                            ...
                            ColumnLayout {
                                ...
                                Text { Layout.alignment: Qt.AlignHCenter; font.family: "Liberation Sans"; font.pixelSize: window.s(14); color: window.overlay0; text: "No active streams" }
                            }
                        }
